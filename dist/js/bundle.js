...
var cursor = function cursor() {
  ...
  gsap__WEBPACK_IMPORTED_MODULE_0__["TweenMax"].to({}, 0.01, {
    repeat: -1,
    onRepeat: function onRepeat() {
      posX += (mouseX - posX) / delay;
      posY += (mouseY - posY) / delay;
      gsap__WEBPACK_IMPORTED_MODULE_0__["TweenMax"].set(follower, {
        css: {
          left: posX,
          top: posY
        }
  ...
  $('a').on({
    mouseenter: function mouseenter(e) {
      if (e.target.text) {
        $('#follower').append('<div id="cursor-text">' + e.target.text + '</div>');
      }
  ...
  $('.menuicon').on({
    mouseenter: function mouseenter() {
      if (_sidebar__WEBPACK_IMPORTED_MODULE_1__["isSidebarOpen"]) {
...
module.exports = __webpack_require__(/*! /Users/misumitakuma/2020/src/js/app.js */"./src/js/app.js");
